        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
          <div className="text-center lg:text-left">
            ...
            <p className="text-muted-foreground">
              © 2024 App Developer Portfolio. Crafted with passion.
            </p>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <a href="https://www.linkedin.com/in/mohammad-ali-yasin/" className="group p-3 rounded-xl bg-card/50 hover:bg-accent border border-border hover:border-accent transition-all duration-300">
              <svg className="w-6 h-6 text-muted-foreground group-hover:text-foreground transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
